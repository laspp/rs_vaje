...
int main (int argc, char *argv[]) 
{
	...
	#pragma omp parallel shared(a, b, c) private(i)
	{
		...
		// This OpenMP pragma distributes the iterations of the following for loop among threads,
		// using a static scheduling policy with a chunk size of 'n_per_thread'.
		// Each thread is assigned contiguous blocks of iterations of size 'n_per_thread' in a round-robin fashion.
		// This can improve load balancing and cache locality when the workload per iteration is uniform.
